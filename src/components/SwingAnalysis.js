                  ...
                  {allMetrics.map((metric) => (
                    <React.Fragment key={metric.key}>
                      <tr 
                        ...
                        className={`metric-row ${selectedMetric === metric.key ? 'active' : ''}`}
                        ...
                        style={{ 
                          ...
                          borderRadius: selectedMetric === metric.key ? '8px 8px 0 0' : '0',
                          position: 'relative'
                        }}
                      >
                        <td style={{ 
                          padding: isMobile ? '12px 8px' : '8px 10px', 
                          borderBottom: selectedMetric === metric.key ? 'none' : '1px dotted #ddd',
                      ...
                      {/* Render insights directly after the metric row */}
